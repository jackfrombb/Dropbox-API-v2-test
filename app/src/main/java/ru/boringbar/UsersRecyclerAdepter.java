...
public class UsersRecyclerAdepter extends RecyclerView.Adapter<UsersRecyclerAdepter.ItemHolder> {

    LayoutInflater inflater;
    List<DropboxUser> users;

    public UsersRecyclerAdepter(Context context, List<DropboxUser> users){
